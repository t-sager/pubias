...
# Import Studynames
studynames <-
  read.csv(file.path("data", "deworming", "sorted_names.csv"))

# Convert to character
studynames <- as.character(studynames[, 1])

# Aply the main function
pubias_meta(
  data,
  studynames,
  GMM = TRUE,
