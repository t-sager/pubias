...
pubias_meta(data, studynames, GMM = FALSE, symmetric = 1, cutoffs = 1.96)

pubias_meta(data, studynames, GMM = TRUE, symmetric = 1, cutoffs = 1.96)
```

Replication Studies
```{r, eval = FALSE}
pubias_replication(data, studynames, GMM = FALSE, symmetric = 1, cutoffs = 1.96)

pubias_replication(data, studynames, GMM = TRUE, symmetric = 1, cutoffs = 1.96)
