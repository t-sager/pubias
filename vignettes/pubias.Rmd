...
This basic specification takes the data and the data and the studynames of the selected identification approach. The rest of the functions arguments are set to their default values. 
...
To further illustrate the functionality of the package, we apply it to on replication study as well as one meta analysis.
These examples are directly taken from the paper by Andrews and Kasy (2019).
